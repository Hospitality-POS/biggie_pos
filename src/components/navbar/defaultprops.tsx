...
const ACCOUNTING_ROUTE_PERMISSIONS: Record<string, string> = {
  ...
  "/accounting/asset-reports": "ACCOUNTING_ASSET_REPORTS_DEPRECIATION",
...
const useProLayoutNav = () => {
  ...
  const accountingAppListBase = [
    ...
    { icon: makeTile("#10b981", ICONS.income), title: "Income", desc: "Income & payments.", url: p("/accounting/income"), _bare: "/accounting/income" },
    { icon: makeTile("#10b981", ICONS.inventory), title: "Inventory", desc: "Track stock levels.", url: p("/inventory"), _bare: "/inventory" },
    ...(!hasPOS ? [
      { icon: makeTile("#6366f1", ICONS.checklist), title: "Services", desc: "Products & services.", url: p("/store"), _bare: "/store" },
      { icon: makeTile("#6366f1", ICONS.checklist), title: "Categories", desc: "Organize categories.", url: p("/Category-settings"), _bare: "/Category-settings" },
    ] : []),
