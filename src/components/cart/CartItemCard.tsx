  ...
  return (
    <Card sx={{ mb: 1, boxShadow: "none", backgroundColor: "#F8F8F8" }}>
      <CardContent>
        ...
        <Grid item display="flex" justifyContent="space-between" alignItems="center" mt={2} columnGap={1}>
          <TextField
          ...
          />
          <Button variant="outlined" color="error" size="small" sx={{ height: 40, borderRadius: "8px" }}>
