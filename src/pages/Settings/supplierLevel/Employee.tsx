...
import { Calendar, Select, Button, Form, Modal, message, Badge, TimePicker, Row, Col, Popover, Space } from 'antd';
...
const RestaurantShiftSchedule = () => {
    ...
    const handleEditShift = (shift) => {
        ...
        form.setFieldsValue({
            ...
            day: shift.day,
            timeRange: [moment(shift.timeRange[0], 'HH:mm'), moment(shift.timeRange[1], 'HH:mm')],
        });
    ...
    return (
        <div className="p-6">
            <h1 className="text-2xl font-bold mb-4">Restaurant Weekly Shift Schedule</h1>
            <Button
                type="primary"
                icon={<PlusOutlined />}
