...
export interface Conversation {
    _id: string;
    channel: "whatsapp" | "africastalking";
...
> = {
    ...
    africastalking: { label: "Africa's Talking", color: "#fa541c", bg: "#fff7e6", icon: <WhatsAppIcon /> },
};

export const WhatsAppIconComponent = WhatsAppIcon;