    ...
    },
    {
      ...
      children: (
        <Space direction="vertical" align="center" style={{ width: "100%" }} size={16}>
          <div style={{ width: "100%" }}>
            <Text style={{ fontSize: 12, color: COLORS.subtext, display: "block", marginBottom: 6, fontWeight: 500 }}>
      ...
      title={
        <Space size={8}>
          <div style={{
            ...
            color: COLORS.primary, fontSize: 16, lineHeight: 1, display: "inline-flex",
          }}>
            <QrcodeOutlined />
          </div>
...
const Dashboard: React.FC = () => {
  ...
  const handleCopyCustomerUrl = useCallback(() => {
    ...
    setUrlModalUrl(url);
    setUrlModalTitle(hospital ? "Patient Portal URL" : hotel ? "Hotel Booking URL" : "Customer Order URL");
    setUrlModalOpen(true);
